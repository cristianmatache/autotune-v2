...
from benchmarks.data.image_dataset_loaders import CIFARLoader
from benchmarks.evaluator import TorchEvaluator
from benchmarks.model_builder import CNNArm, CNNBuilder
...
class CifarProblem(HyperparameterOptimizationProblem):
    ...
    def __init__(self, data_dir: str, output_dir: str,
        ...
        dataset_loader = CIFARLoader(data_dir)
